...
<!-- Enhanced CTE & CTO Page - Subtle Animations -->
<div class="cte-cto-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-40">
                    <div class="animated-image-container">
                        <div class="images">
                            <img src="{{asset('assets/images/service/consent-to-establish.jpg')}}" alt="Consent to Establish (CTE) & Consent to Operate (CTO)" class="enhanced-image">
                        </div>
                    </div>
                </div>
...
<style>
/* ENHANCED CTE & CTO PAGE WITH SUBTLE ANIMATIONS */
