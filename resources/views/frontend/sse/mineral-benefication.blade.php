...
@section('content')
    <!--Full width header End-->
        ...
        {{-- <div class="rs-breadcrumbs img1"
            style="background: linear-gradient(135deg, rgba(21, 110, 104, 0.85), rgba(13, 75, 70, 0.9)), url({{asset('assets/images/mineral-beneficiation-ec-banner-bg.jpg')}}) no-repeat center center; background-size: cover;">
            <div class="breadcrumbs-inner text-center">
                <h1 class="page-title">Environmental Clearance for Mineral Beneficiation</h1>
                <ul>
                    <li title="Bhoomija - Environmental Consultancy Services">
                        <a class="active" href="{{route('home')}}">Home</a>
                    </li>
                    <li>Services /</li>
                    <li>Mineral Beneficiation EC</li>
                </ul>
            </div>
        </div> --}}
        <!-- Breadcrumbs End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 md-mb-30">
                        <div class="rs-animation-shape">
                            <div class="images">
                                <img src="{{asset('assets/images/mineral-beneficiation-ec-img.jpg')}}" alt="Environmental Clearance for Mineral Beneficiation" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="contact-wrap">
                            <div class="sec-title mb-30">
                                ...
                                <h2 class="title pb-38">
                                    Environmental Clearance for Mineral Beneficiation
                                </h2>
                                <div class="desc pb-35">
                                    <strong>Mineral Beneficiation</strong> involves physical and chemical processing to upgrade mineral ores and improve their economic value. These processes—such as <strong>crushing, grinding, washing, magnetic separation, and flotation</strong>—can generate significant environmental impacts including <strong>dust emissions, wastewater discharge, and tailings generation</strong>.
                                </div>
                                <div class="desc pb-35">
                                    As per <strong>Schedule 2(a)</strong> of the <strong>EIA Notification, 2006</strong>, <strong>Mineral Beneficiation Projects</strong> require prior <strong>Environmental Clearance (EC)</strong> before establishment, expansion, or modernization.
                                </div>
                                <div class="desc pb-35">
                                    At <strong>{{env('SITENAME')}}, </strong>we provide expert consultancy services to guide mineral beneficiation projects through the EC process, ensuring compliance with all regulatory requirements and facilitating sustainable operations.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-services style2 pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Mineral Beneficiation EC Services</h2>
                    <div class="desc mt-10">Comprehensive support for Environmental Clearance in the Mineral Beneficiation Sector</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'B' EC for Mineral Beneficiation</h4>
                                <p class="desc">Complete assistance for mineral beneficiation projects requiring EC from State Level Environmental Impact Assessment Authorities (SEIAAs).</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Project registration and documentation under Schedule 2(a)</li>
                                    <li>EIA/EMP report preparation and review specific to beneficiation processes</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">EIA & EMP Reports for Mineral Beneficiation</h4>
                                <p class="desc">Development of comprehensive Environmental Impact Assessment (EIA) and Environment Management Plan (EMP) reports tailored for beneficiation operations.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Baseline environmental studies (air, water, soil, noise, dust)</li>
                                    <li>Prediction and assessment of impacts from processing operations and tailings</li>
                                    <li>Formulation of mitigation measures for dust, effluents, and solid waste</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Water & Effluent Management Plans</h4>
                                <p class="desc">Specialized planning for water conservation, recycling, and treatment of process effluents in beneficiation plants.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Design and assessment of water recycling systems</li>
                                    <li>Development of effluent treatment plant (ETP) design basis</li>
                                    <li>Tailings management and disposal strategies</li>
                                    <li>Monitoring and compliance strategies for water quality standards</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Dust & Air Pollution Control</h4>
                                <p class="desc">Strategies for controlling particulate matter and gaseous emissions from beneficiation processes.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Assessment of fugitive dust emissions from crushers, screens, conveyors</li>
                                    <li>Design of dust suppression and extraction systems</li>
                                    <li>Stack emission monitoring and control plan</li>
                                    <li>Air quality modeling and impact prediction</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-about pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Mineral Beneficiation EC Process</h2>
                    <div class="desc mt-10">Systematic methodology for obtaining Environmental Clearance for mineral beneficiation projects</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Initial steps to register the mineral beneficiation project under Schedule 2(a) with the appropriate State authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Review of project details (ore type, capacity, technology, location)</li>
                                    <li>Confirmation of applicability under Schedule 2(a)</li>
                                    <li>Registration on PARIVESH portal</li>
                                    <li>Preparation of Terms of Reference (ToR) for EIA</li>
                                </ul>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Conducting detailed studies and compiling the Environmental Impact Assessment and Management Plan reports specific to beneficiation.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Comprehensive baseline studies including air, water, noise, and ecology</li>
                                    <li>Specialized impact assessment for dust, effluents, and tailings management</li>
                                    <li>Stakeholder consultation and public hearing facilitation</li>
                                    <li>Formulation of detailed EMP with mitigation, monitoring, and Disaster Management Plan</li>
                                </ul>
                                <div class="process-step-indicator">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Compiling and submitting the complete EC application package to the State EIA Authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Preparation of EC application form and checklist</li>
                                    <li>Compilation of EIA/EMP report and other required documents</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Representation before State Expert Appraisal Committee</li>
        ...
        <div class="rs-services style2 gray-color pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Benefits of Our Mineral Beneficiation EC Services</h2>
        ...
        <div class="rs-contact-wrap bg5 pt-80 pb-80 md-pt-80 pb-80" style="background: linear-gradient(rgb(0 24 24 / 84%) 100%, rgb(0 44 2) 100%), url(https://www.pnas.org/content/118/32/e2112863118/F1.large.jpg) no-repeat; background-size: cover;">
            <div class="container">
                <div class="sec-title2 text-center mb-30">
                    <p class="title white-color" style="max-width:100%;">Would You Like to know more on how {{env('SITENAME')}} can help you obtain Environmental Clearance for your Mineral Beneficiation Project?</p>
                    <button class="readon learn-more submit mb-30 mt-30">
                        <a href="{{route('contact-us')}}" class="text-white">Contact Us</a>
                    </button>
                    <div class="text-white">With extensive experience in mineral sector environmental clearances, {{env('SITENAME')}} provides expert services to ensure your beneficiation project meets all regulatory requirements. Our dedicated team manages the entire EC process from initial registration to final clearance, guaranteeing accuracy and timeliness.</div>
                </div>
            </div>
        </div>
        <hr>
