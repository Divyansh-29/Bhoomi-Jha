...
@section('content')
    <!--Full width header End-->
        ...
        {{-- <div class="rs-breadcrumbs img1"
            style="background: linear-gradient(135deg, rgba(21, 110, 104, 0.85), rgba(13, 75, 70, 0.9)), url({{asset('assets/images/coal-washery-ec-banner-bg.jpg')}}) no-repeat center center; background-size: cover;">
            <div class="breadcrumbs-inner text-center">
                <h1 class="page-title">Environmental Clearance for Coal Washeries</h1>
                <ul>
                    <li title="Bhoomija - Environmental Consultancy Services">
                        <a class="active" href="{{route('home')}}">Home</a>
                    </li>
                    <li>Services /</li>
                    <li>Coal Washeries EC</li>
                </ul>
            </div>
        </div> --}}
        <!-- Breadcrumbs End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 md-mb-30">
                        <div class="rs-animation-shape">
                            <div class="images">
                                <img src="{{asset('assets/images/coal-washery-ec-img.png')}}" alt="Environmental Clearance for Coal Washeries" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="contact-wrap">
                            <div class="sec-title mb-30">
                                ...
                                <h2 class="title pb-38">
                                    Environmental Clearance for Coal Washeries
                                </h2>
                                <div class="desc pb-35">
                                    Under <strong>Schedule 2(a)</strong> of the <strong>EIA Notification, 2006</strong>, all <strong>Coal Washeries</strong> are mandated to obtain prior <strong>Environmental Clearance (EC)</strong> before construction, expansion, or modernization.
                                </div>
                                <div class="desc pb-35">
                                    Coal washeries involve large-scale handling, screening, washing, and beneficiation of coal, which may lead to environmental impacts such as <strong>air and water pollution, waste generation, and ecological disturbance</strong>.
                                </div>
                                <div class="desc pb-35">
                                    The EC process ensures that potential environmental impacts are identified, mitigated, and managed through a structured <strong>Environmental Management Plan (EMP)</strong> in line with statutory guidelines.
                                </div>
                                <div class="desc pb-35">
                                    At <strong>{{env('SITENAME')}}, </strong>we provide expert consultancy services to guide coal washery projects through the EC process, ensuring compliance with all regulatory requirements and facilitating sustainable operations.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-services style2 pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Coal Washery EC Services</h2>
                    <div class="desc mt-10">Comprehensive support for Environmental Clearance in the Coal Washery Sector</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'B' EC for Coal Washeries</h4>
                                <p class="desc">Complete assistance for coal washery projects requiring EC from State Level Environmental Impact Assessment Authorities (SEIAAs).</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    ...
                                    <li>EIA/EMP report preparation and review specific to coal washeries</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">EIA & EMP Reports for Coal Washeries</h4>
                                <p class="desc">Development of comprehensive Environmental Impact Assessment (EIA) and Environment Management Plan (EMP) reports tailored for coal washing operations.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Baseline environmental studies (air, water, soil, noise, dust)</li>
                                    <li>Prediction and assessment of impacts from coal handling, washing, and slurry disposal</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Specialized planning for water conservation, recycling, and treatment of washery effluents.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Design and assessment of water recycling systems</li>
                                    <li>Development of effluent treatment plant (ETP) design basis</li>
                                    <li>Slurry management and disposal strategies</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Strategies for controlling particulate matter and gaseous emissions from coal handling and processing.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Assessment of fugitive dust emissions</li>
        ...
        <div class="rs-about pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Coal Washery EC Process</h2>
                    <div class="desc mt-10">Systematic methodology for obtaining Environmental Clearance for coal washery projects</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Initial steps to register the coal washery project under Schedule 2(a) with the appropriate State authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Review of project details (capacity, technology, location)</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Conducting detailed studies and compiling the Environmental Impact Assessment and Management Plan reports specific to coal washeries.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Comprehensive baseline studies including air, water, noise, and ecology</li>
                                    <li>Specialized impact assessment for dust, effluents, and solid waste</li>
        ...
        <div class="rs-services style2 gray-color pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Benefits of Our Coal Washery EC Services</h2>
        ...
        <div class="rs-contact-wrap bg5 pt-80 pb-80 md-pt-80 pb-80" style="background: linear-gradient(rgb(0 24 24 / 84%) 100%, rgb(0 44 2) 100%), url(https://www.pnas.org/content/118/32/e2112863118/F1.large.jpg) no-repeat; background-size: cover;">
            <div class="container">
                <div class="sec-title2 text-center mb-30">
                    <p class="title white-color" style="max-width:100%;">Would You Like to know more on how {{env('SITENAME')}} can help you obtain Environmental Clearance for your Coal Washery Project?</p>
                    <button class="readon learn-more submit mb-30 mt-30">
                        <a href="{{route('contact-us')}}" class="text-white">Contact Us</a>
                    </button>
                    <div class="text-white">With extensive experience in coal sector environmental clearances, {{env('SITENAME')}} provides expert services to ensure your coal washery project meets all regulatory requirements. Our dedicated team manages the entire EC process from initial registration to final clearance, guaranteeing accuracy and timeliness.</div>
                </div>
            </div>
        </div>
        <hr>
        ...
        <!-- Video Section End -->
<style>
/* Custom styles for coal washery EC page - Reusing Thermal Power EC styles with minor adjustments */
.services-item {
