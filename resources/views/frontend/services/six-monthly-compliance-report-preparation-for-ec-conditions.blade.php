...
<!-- Enhanced Six-Monthly Compliance Report for EC Conditions Page - Subtle Animations -->
<div class="sixmonthly-compliance-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-40">
                    <div class="animated-image-container">
                        <div class="images">
                            <img src="{{asset('assets/images/service/six-monthly.jpg')}}" alt="Six-Monthly Compliance Report for Environmental Clearance (EC) Conditions" class="enhanced-image">
                        </div>
                    </div>
                </div>
...
<style>
/* ENHANCED SIX-MONTHLY COMPLIANCE REPORT FOR EC CONDITIONS PAGE WITH SUBTLE ANIMATIONS */
...
.sixmonthly-compliance-page-wrapper {
    position: relative;
    overflow: hidden;
...
.sixmonthly-compliance-page-wrapper::before {
    content: '';
    position: absolute;
    top: 15%;
    right: -5%;
...
.sixmonthly-compliance-page-wrapper::after {
    content: '';
    position: absolute;
    bottom: 25%;
    left: -8%;
