                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 md-mb-30">
                        <div class="rs-animation-shape animated-image-container">
                            <div class="images">
                                <img src="{{asset('assets/images/coal-washery-ec-img.png')}}" alt="Environmental Clearance for Coal Washeries" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);" class="animated-image">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 pl-60 md-pl-15">
                        <div class="contact-wrap">
                            <div class="sec-title mb-30">
                                ...
                                <div class="desc pb-35 animated-desc-4">
...
<style>
/* ANIMATED COAL WASHERIES EC PAGE STYLES */
...
/* Description Animations - Staggered for 4 descriptions */
.animated-desc {
    opacity: 0;
    transform: translateY(20px);
