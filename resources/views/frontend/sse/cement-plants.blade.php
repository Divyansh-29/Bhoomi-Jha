...
@section('content')
    <!--Full width header End-->
        ...
        {{-- <div class="rs-breadcrumbs img1"
            style="background: linear-gradient(135deg, rgba(21, 110, 104, 0.85), rgba(13, 75, 70, 0.9)), url({{asset('assets/images/cement-plant-ec-banner-bg.jpg')}}) no-repeat center center; background-size: cover;">
            <div class="breadcrumbs-inner text-center">
                <h1 class="page-title">Environmental Clearance for Cement Plants</h1>
                <ul>
                    <li title="Bhoomija - Environmental Consultancy Services">
                        <a class="active" href="{{route('home')}}">Home</a>
                    </li>
                    <li>Services /</li>
                    <li>Cement Plants EC</li>
                </ul>
            </div>
        </div> --}}
        <!-- Breadcrumbs End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 md-mb-30">
                        <div class="rs-animation-shape">
                            <div class="images">
                                <img src="{{asset('assets/images/cement-plant-ec-img.webp')}}" alt="Environmental Clearance for Cement Plants" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="contact-wrap">
                            <div class="sec-title mb-30">
                                ...
                                <div class="desc pb-35">
                                    <strong>Cement plants</strong> are major infrastructure and industrial projects involving the manufacturing of cement through <strong>raw material processing, clinker production, and grinding units</strong>. These processes generate significant <strong>air pollution (e.g., particulate matter, NOx, SO₂)</strong>, consume large quantities of <strong>water and energy</strong>, and contribute to <strong>greenhouse gas emissions</strong>.
                                </div>
                                <div class="desc pb-35">
                                    To mitigate environmental impact, <strong>Cement Plants</strong> are listed under <strong>Schedule 3(b)</strong> of the <strong>EIA Notification, 2006</strong>, and must obtain prior <strong>Environmental Clearance (EC)</strong> before establishment, expansion, or modernization.
                                </div>
                                <div class="desc pb-35">
                                    At <strong>{{env('SITENAME')}}, </strong>we provide expert consultancy services to guide cement plant projects through the complex EC process, ensuring compliance with all regulatory requirements and facilitating sustainable operations.
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-services style2 pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Cement Plant EC Services</h2>
                    <div class="desc mt-10">Comprehensive support for Environmental Clearance in the Cement Industry</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'A' EC for Cement Plants</h4>
                                <p class="desc">End-to-end support for Category 'A' cement plant projects requiring EC from the Ministry of Environment, Forest and Climate Change (MoEF&CC).</p>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'B' EC for Cement Plants</h4>
                                <p class="desc">Complete assistance for Category 'B' cement plant projects requiring EC from State Level Environmental Impact Assessment Authorities (SEIAAs).</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">EIA & EMP Reports for Cement Plants</h4>
                                <p class="desc">Development of comprehensive Environmental Impact Assessment (EIA) and Environment Management Plan (EMP) reports tailored for cement manufacturing.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Specialized strategies for controlling emissions and effluents from cement manufacturing processes.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Assessment of stack and fugitive emissions (PM, NOx, SOx, CO2)</li>
        ...
        <div class="rs-about pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Cement Plant EC Process</h2>
                    <div class="desc mt-10">Systematic methodology for obtaining Environmental Clearance for cement plant projects</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Initial steps to determine the correct category and register the cement plant project with the appropriate authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Conducting detailed studies and compiling the Environmental Impact Assessment and Management Plan reports specific to cement plants.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
        ...
        <div class="rs-services style2 gray-color pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Benefits of Our Cement Plant EC Services</h2>
        ...
        <div class="rs-contact-wrap bg5 pt-80 pb-80 md-pt-80 pb-80" style="background: linear-gradient(rgb(0 24 24 / 84%) 100%, rgb(0 44 2) 100%), url(https://www.pnas.org/content/118/32/e2112863118/F1.large.jpg) no-repeat; background-size: cover;">
            <div class="container">
                <div class="sec-title2 text-center mb-30">
                    <p class="title white-color" style="max-width:100%;">Would You Like to know more on how {{env('SITENAME')}} can help you obtain Environmental Clearance for your Cement Plant Project?</p>
                    <button class="readon learn-more submit mb-30 mt-30">
                        <a href="{{route('contact-us')}}" class="text-white">Contact Us</a>
                    </button>
                    <div class="text-white">With extensive experience in cement sector environmental clearances, {{env('SITENAME')}} provides expert services to ensure your project meets all regulatory requirements. Our dedicated team manages the entire EC process from initial registration to final clearance, guaranteeing accuracy and timeliness.</div>
                </div>
            </div>
        </div>
        <hr>
        ...
        <!-- Video Section End -->
<style>
/* Custom styles for cement plant EC page - Reusing Metallurgical EC styles with minor adjustments */
.services-item {
