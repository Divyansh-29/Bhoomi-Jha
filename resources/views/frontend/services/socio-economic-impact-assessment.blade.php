...
<!-- Enhanced Socio-Economic Impact Assessments (SEIA) Page - Subtle Animations -->
<div class="seia-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-40">
                    <div class="animated-image-container">
                        <div class="images">
                            <img src="{{asset('assets/images/service/socio.jpg')}}" alt="Socio-Economic Impact Assessments (SEIA)" class="enhanced-image">
                        </div>
                    </div>
                </div>
...
<style>
/* ENHANCED SOCIO-ECONOMIC IMPACT ASSESSMENTS (SEIA) PAGE WITH SUBTLE ANIMATIONS */
