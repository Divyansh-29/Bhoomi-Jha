        ...
        <div class="rs-services style2 pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Thermal Power Plant EC Services</h2>
                    <div class="desc mt-10">Comprehensive support for Environmental Clearance in the Thermal Power Sector</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'A' EC for Thermal Power Plants</h4>
                                <p class="desc">End-to-end support for Category 'A' thermal power plant projects requiring EC from the Ministry of Environment, Forest and Climate Change (MoEF&CC).</p>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'B' EC for Thermal Power Plants</h4>
                                <p class="desc">Complete assistance for Category 'B' thermal power plant projects requiring EC from State Level Environmental Impact Assessment Authorities (SEIAAs).</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">EIA & EMP Reports for Thermal Power Plants</h4>
                                <p class="desc">Development of comprehensive Environmental Impact Assessment (EIA) and Environment Management Plan (EMP) reports tailored for thermal power operations.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Baseline environmental studies (air, water, soil, noise, flora, fauna)</li>
                                    <li>Prediction and assessment of potential impacts (including emissions, effluents, fly ash)</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Forest & CRZ Clearance for Thermal Power Plants</h4>
                                ...
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    ...
                                    <li>CRZ mapping and impact assessment for coastal power plants</li>
        ...
        <div class="rs-about pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Thermal Power Plant EC Process</h2>
                    <div class="desc mt-10">Systematic methodology for obtaining Environmental Clearance for thermal power projects</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Initial steps to determine the correct category and register the thermal power plant project with the appropriate authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Review of project details (capacity, fuel type, location)</li>
                                    <li>Determination of Category 'A' or 'B' based on plant capacity and fuel</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Conducting detailed studies and compiling the Environmental Impact Assessment and Management Plan reports specific to thermal power plants.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Comprehensive baseline studies including air, water, noise, and ecology</li>
                                    <li>Specialized impact assessment for emissions, effluents, and fly ash management</li>
                                    <li>Stakeholder consultation and public hearing facilitation</li>
                                    <li>Formulation of detailed EMP with mitigation, monitoring, and Emergency Preparedness Plan</li>
                                </ul>
                                <div class="process-step-indicator">
        ...
        <div class="rs-services style2 gray-color pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Benefits of Our Thermal Power Plant EC Services</h2>
        ...
        <div class="rs-contact-wrap bg5 pt-80 pb-80 md-pt-80 pb-80" style="background: linear-gradient(rgb(0 24 24 / 84%) 100%, rgb(0 44 2) 100%), url(https://www.pnas.org/content/118/32/e2112863118/F1.large.jpg) no-repeat; background-size: cover;">
            <div class="container">
                <div class="sec-title2 text-center mb-30">
                    <p class="title white-color" style="max-width:100%;">Would You Like to know more on how {{env('SITENAME')}} can help you obtain Environmental Clearance for your Thermal Power Plant Project?</p>
                    <button class="readon learn-more submit mb-30 mt-30">
                        <a href="{{route('contact-us')}}" class="text-white">Contact Us</a>
                    </button>
                    <div class="text-white">With extensive experience in thermal power sector environmental clearances, {{env('SITENAME')}} provides expert services to ensure your power plant project meets all regulatory requirements. Our dedicated team manages the entire EC process from initial registration to final clearance, guaranteeing accuracy and timeliness.</div>
                </div>
            </div>
        </div>
        <hr>
