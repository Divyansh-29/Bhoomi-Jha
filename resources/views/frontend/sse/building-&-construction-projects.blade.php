...
@section('content')
    <!--Full width header End-->
        ...
        {{-- <div class="rs-breadcrumbs img1"
            style="background: linear-gradient(135deg, rgba(21, 110, 104, 0.85), rgba(13, 75, 70, 0.9)), url({{asset('assets/images/building-construction-ec-banner-bg.jpg')}}) no-repeat center center; background-size: cover;">
            <div class="breadcrumbs-inner text-center">
                <h1 class="page-title">Environmental Clearance for Building and Construction Projects</h1>
                <ul>
                    <li title="Bhoomija - Environmental Consultancy Services">
                        <a class="active" href="{{route('home')}}">Home</a>
                    </li>
                    <li>Services /</li>
                    <li>Building and Construction Projects EC</li>
                </ul>
            </div> --}}
        </div>
        <!-- Breadcrumbs End -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 md-mb-30">
                        <div class="rs-animation-shape">
                            <div class="images">
                                <img src="{{asset('assets/images/building-construction-ec-img.jpg')}}" alt="Environmental Clearance for Building and Construction Projects" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-services style2 pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Building and Construction Projects EC Services</h2>
                    <div class="desc mt-10">Comprehensive support for Environmental Clearance in the Building & Construction Sector</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'B' EC for Building Projects</h4>
                                <p class="desc">Complete assistance for building and construction projects requiring EC from State Level Environmental Impact Assessment Authorities (SEIAAs).</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Project registration and documentation under Schedule 8(a)</li>
                                    <li>EIA/EMP report preparation and review specific to construction activities</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">EIA & EMP Reports for Construction</h4>
                                <p class="desc">Development of comprehensive Environmental Impact Assessment (EIA) and Environment Management Plan (EMP) reports tailored for building projects.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Baseline environmental studies (air, water, soil, noise, ecology)</li>
                                    <li>Prediction and assessment of impacts from construction activities</li>
                                    <li>Formulation of mitigation measures for dust, noise, and waste management</li>
                                    <li>Stakeholder consultation and Social Impact Assessment (SIA)</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <!-- Construction Waste & Water Management -->
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100">
                            <div class="services-icon-wrapper">
                                <div class="services-icon">
                                    <!-- SVG Icon for Waste/Water Management -->
                                    <svg class="sector-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#156e68" stroke-width="1.5">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Waste & Water Management Plans</h4>
                                <p class="desc">Specialized planning for construction waste handling and water resource management.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Development of construction and demolition waste management plans</li>
                                    <li>Design and assessment of water recycling and rainwater harvesting systems</li>
                                    <li>Stormwater management and drainage planning</li>
                                    <li>Monitoring and compliance strategies for waste and water standards</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100">
                            <div class="services-icon-wrapper">
                                <div class="services-icon">
                                    <!-- SVG Icon for Noise/Air Quality -->
                                    <svg class="sector-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#156e68" stroke-width="1.5">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Noise & Air Pollution Control</h4>
                                <p class="desc">Strategies for controlling noise and dust emissions from construction activities.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Assessment of construction noise and fugitive dust emissions</li>
                                    <li>Design of noise barriers and dust suppression measures</li>
                                    <li>Implementation of best practices for construction site management</li>
                                    <li>Air quality and noise monitoring during construction phase</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-about pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Building Projects EC Process</h2>
                    <div class="desc mt-10">Systematic methodology for obtaining Environmental Clearance for building and construction projects</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Initial steps to register the building project under Schedule 8(a) with the appropriate State authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Review of project details (type, area, location, number of units)</li>
                                    <li>Confirmation of applicability under Schedule 8(a)</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Conducting detailed studies and compiling the Environmental Impact Assessment and Management Plan reports specific to construction.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Comprehensive baseline studies including air, water, noise, and ecology</li>
                                    <li>Specialized impact assessment for dust, noise, and waste generation</li>
                                    <li>Stakeholder consultation and public hearing facilitation</li>
                                    <li>Formulation of detailed EMP with mitigation, monitoring, and ESZ guidelines</li>
                                </ul>
                                <div class="process-step-indicator">
        ...
        <div class="rs-services style2 gray-color pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Benefits of Our Building Projects EC Services</h2>
        ...
        <div class="rs-contact-wrap bg5 pt-80 pb-80 md-pt-80 pb-80" style="background: linear-gradient(rgb(0 24 24 / 84%) 100%, rgb(0 44 2) 100%), url(https://www.pnas.org/content/118/32/e2112863118/F1.large.jpg) no-repeat; background-size: cover;">
            <div class="container">
                <div class="sec-title2 text-center mb-30">
                    <p class="title white-color" style="max-width:100%;">Would You Like to know more on how {{env('SITENAME')}} can help you obtain Environmental Clearance for your Building and Construction Project?</p>
                    <button class="readon learn-more submit mb-30 mt-30">
                        <a href="{{route('contact-us')}}" class="text-white">Contact Us</a>
                    </button>
                    <div class="text-white">With extensive experience in building sector environmental clearances, {{env('SITENAME')}} provides expert services to ensure your project meets all regulatory requirements. Our dedicated team manages the entire EC process from initial registration to final clearance, guaranteeing accuracy and timeliness.</div>
                </div>
            </div>
        </div>
        <hr>
        ...
        <!-- Video Section End -->
<style>
/* Custom styles for building construction EC page - Reusing Cement Plant EC styles with minor adjustments */
.services-item {
