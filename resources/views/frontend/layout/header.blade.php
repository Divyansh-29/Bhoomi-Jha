                        ...
                        <nav class="rs-menu">   
                            <ul class="nav-menu"><li id="menu-item-37" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home nav-item menu-item-37 nav-item"><a href="{{route('home')}}">Home</a></li>
                                ...
                                <ul class="menu-item-has-children">
                                    <li id="menu-item-42" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-42 nav-item"><a href="{{route('service','environmental-clearence')}}">Environmental Impacts Assessment (EIA) Studies</a></li>
                                    <li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-44 nav-item"><a href="{{route('service','ground-water-clearence')}}">Environmental Monitoring</a></li>
                                    <li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-39 nav-item"><a href="{{route('service','consent-to-establish-and-operate')}}">Environmental Audits</a></li>
                                    <li id="menu-item-48" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-48 nav-item"><a href="{{route('service','periodic-compliance-audits')}}">Forest Clearance (FC), Wildlife Clearance (WC)</a></li>
                                    <li id="menu-item-43" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-43 nav-item"><a href="{{route('service','green-building-cetification')}}">Consent to Estalish and Operate (SPBs)</a></li>
                                    <li id="menu-item-40" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-40 nav-item"><a href="{{route('service','design-services')}}">CTE/CTO Renewal Application</a></li>
                                    <li id="menu-item-47" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-47 nav-item"><a href="{{route('service','operations-and-maintenance')}}">Six Monthly Compliance Report Preparation For EC Conditions</a></li>
                                    <li id="menu-item-42" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-42 nav-item"><a href="{{route('service','environmental-clearence')}}">Carbon Foot Print & Climate Change Studies</a></li>
                                    <li id="menu-item-44" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-44 nav-item"><a href="{{route('service','ground-water-clearence')}}">Socio-Economic Impact Assessment</a></li>
                                    <li id="menu-item-39" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-39 nav-item"><a href="{{route('service','consent-to-establish-and-operate')}}">Design & Engineering for Tech MBBR, SBR, ASP, MBR, etc (STP, ETP & CPU etc)</a></li>
                                    <li id="menu-item-48" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-48 nav-item"><a href="{{route('service','periodic-compliance-audits')}}">Forest Clearance (FC), Wildlife Clearance (WC)</a></li>
                                    <li id="menu-item-43" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-43 nav-item"><a href="{{route('service','green-building-cetification')}}">Consent to Estalish and Operate (SPBs)</a></li>
                                    <li id="menu-item-40" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-40 nav-item"><a href="{{route('service','design-services')}}">CTE/CTO Renewal Application</a></li>
                                    <li id="menu-item-47" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-47 nav-item"><a href="{{route('service','operations-and-maintenance')}}">Six Monthly Compliance Report Preparation For EC Conditions</a></li>
                            ...
                            <li id="menu-item-61" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-61 nav-item"><a href="{{route('contact-us')}}">Clientele</a></li>
                            <li id="menu-item-61" class="menu-item menu-item-type-post_type menu-item-object-page nav-item menu-item-61 nav-item"><a href="{{route('contact-us')}}">Careers</a></li>
