...
<!-- Enhanced Environmental Monitoring Page - Subtle Animations -->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-40">
                    <div class="animated-image-container">
                        <div class="images">
                            <img src="{{asset('assets/images/service/environmental-monitoring.jpg')}}" alt="Environmental Monitoring" class="enhanced-image">
                        </div>
                    </div>
                </div>
...
<style>
/* ENHANCED ENVIRONMENTAL MONITORING PAGE WITH SUBTLE ANIMATIONS */
...
.monitoring-page-wrapper::before {
    content: '';
    position: absolute;
    top: 15%;
    right: -5%;
