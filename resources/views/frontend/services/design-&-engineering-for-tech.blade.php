...
<!-- Enhanced Design & Engineering Services for STP, ETP & CPU Page - Subtle Animations -->
<div class="stp-etp-cpu-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-40">
                    <div class="animated-image-container">
                        <div class="images">
                            <img src="{{asset('assets/images/service/stp.jpg')}}" alt="Design & Engineering Services for STP, ETP & CPU" class="enhanced-image">
                        </div>
                    </div>
                </div>
...
<style>
/* ENHANCED DESIGN & ENGINEERING SERVICES FOR STP, ETP & CPU PAGE WITH SUBTLE ANIMATIONS */
...
.stp-etp-cpu-page-wrapper::before {
    content: '';
    position: absolute;
    top: 15%;
    right: -5%;
...
.stp-etp-cpu-page-wrapper::after {
    content: '';
    position: absolute;
    bottom: 25%;
    left: -8%;
