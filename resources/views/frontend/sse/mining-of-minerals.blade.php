                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 md-mb-30">
                        <div class="rs-animation-shape animated-image-container">
                            <div class="images">
                                <img src="{{asset('assets/images/mining-ec-img.jpg')}}" alt="Environmental Clearance for Mining of Minerals" style="border-radius: 10px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);" class="animated-image">
                            </div>
                        </div>
                    </div>
...
<style>
/* ANIMATED MINING EC PAGE STYLES */
