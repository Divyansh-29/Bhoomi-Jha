...
<!-- Enhanced Carbon Footprint & Climate Change Studies Page - Subtle Animations -->
<div class="carbon-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 md-mb-40">
                    <div class="animated-image-container">
                        <div class="images">
                            <img src="{{asset('assets/images/service/carbon-footprints.jpg')}}" alt="Carbon Footprint & Climate Change Studies" class="enhanced-image">
                        </div>
                    </div>
                </div>
...
<style>
/* ENHANCED CARBON FOOTPRINT & CLIMATE CHANGE STUDIES PAGE WITH SUBTLE ANIMATIONS */
