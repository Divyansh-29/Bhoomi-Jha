        ...
        <div class="rs-services style2 pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Mining EC Services</h2>
                    <div class="desc mt-10">Comprehensive support for Environmental Clearance in the Mining Sector</div>
                </div>
                <div class="row gutter-40">
                        ...
                        <div class="services-item hover-bg h-100">
                            <div class="services-icon-wrapper">
                                <div class="services-icon">
                                    <!-- SVG Icon for Category A - Circle Removed -->
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'A' EC for Mining</h4>
                                <p class="desc">End-to-end support for Category 'A' mining projects requiring EC from the Ministry of Environment, Forest and Climate Change (MoEF&CC).</p>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100">
                            <div class="services-icon-wrapper">
                                <div class="services-icon">
                                    <!-- SVG Icon for Category B - Circle Removed -->
                                    <svg class="sector-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#156e68" stroke-width="1.5">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">Category 'B' EC for Mining</h4>
                                <p class="desc">Complete assistance for Category 'B' mining projects requiring EC from State Level Environmental Impact Assessment Authorities (SEIAAs).</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100">
                            <div class="services-icon-wrapper">
                                <div class="services-icon">
                                    <!-- SVG Icon for EIA/EMP - Circle Removed -->
                                    <svg class="sector-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#156e68" stroke-width="1.5">
                            ...
                            <div class="services-content text-left">
                                <h4 class="title">EIA & EMP Reports for Mining</h4>
                                <p class="desc">Development of comprehensive Environmental Impact Assessment (EIA) and Environment Management Plan (EMP) reports tailored for mining operations.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Baseline environmental studies (air, water, soil, noise, flora, fauna)</li>
                                    <li>Prediction and assessment of potential impacts</li>
                                    <li>Formulation of mitigation measures and monitoring programs</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100">
                            <div class="services-icon-wrapper">
                                <div class="services-icon">
                                    <!-- SVG Icon for Forest/CRZ - Circle Removed -->
                                    <svg class="sector-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#156e68" stroke-width="1.5">
                                        <path d="M12 2L2 12h3v8h14v-8h3L12 2z" />
                                        <path d="M8 16v-4a4 4 0 1 1 8 0v4" />
                                        <path d="M9 20v-1h6v1" />
                                    </svg>
                                </div>
                            </div>
                            <div class="services-content text-left">
                                <h4 class="title">Forest & CRZ Clearance for Mining</h4>
                                <p class="desc">Integrated support for obtaining Forest Clearance (FC) under the Forest Conservation Act and Coastal Regulation Zone (CRZ) clearance where applicable.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Preparation of Forest Conservation Plan and Net Present Value (NPV) calculations</li>
                                    <li>CRZ mapping and impact assessment for coastal mining projects</li>
                                    <li>Coordination with Forest Departments and Coastal Zone Management Authorities</li>
                                    <li>Assistance in compensatory afforestation and rehabilitation plans</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="rs-about pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Mining EC Process</h2>
                    <div class="desc mt-10">Systematic methodology for obtaining Environmental Clearance for mining projects</div>
                </div>
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Initial steps to determine the correct category and register the mining project with the appropriate authority.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Review of project details and mining lease area</li>
                                    <li>Determination of Category 'A' or 'B' based on mineral type and production capacity</li>
                    ...
                    <div class="col-lg-6 col-md-12 mb-40">
                        <div class="services-item hover-bg h-100">
                            <div class="services-content text-left">
                                ...
                                <p class="desc">Conducting detailed studies and compiling the Environmental Impact Assessment and Management Plan reports.</p>
                                <ul style="list-style: disc; padding: 15px 20px; margin-top: 15px;">
                                    <li>Baseline environmental and socio-economic studies</li>
                                    <li>Impact prediction and significance analysis</li>
                                    <li>Stakeholder consultation and public hearing facilitation</li>
                                    <li>Formulation of comprehensive EMP with mitigation measures</li>
                                </ul>
                                <div class="process-step-indicator">
        ...
        <div class="rs-services style2 gray-color pt-80 pb-80 md-pt-80 md-pb-80">
            <div class="container">
                <div class="sec-title text-center mb-60">
                    ...
                    <h2 class="title">Benefits of Our Mining EC Services</h2>
                ...
                <div class="row gutter-40">
                    ...
                    <div class="col-lg-3 col-md-6 mb-40 wow fadeInUp">
                        <div class="services-item hover-bg h-100 d-flex flex-column align-items-center text-center">
                            <!-- <div class="benefit-icon mb-4"> -->
                                <!-- CSS Icon for Compliance Removed -->
                                <!-- <div class="css-icon compliance">
                    ...
                    <div class="col-lg-3 col-md-6 mb-40 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="services-item hover-bg h-100 d-flex flex-column align-items-center text-center">
                            <!-- <div class="benefit-icon mb-4"> -->
                                <!-- CSS Icon for Timely Removed -->
                                <!-- <div class="css-icon timely">
                    ...
                    <div class="col-lg-3 col-md-6 mb-40 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="services-item hover-bg h-100 d-flex flex-column align-items-center text-center">
                            <!-- <div class="benefit-icon mb-4"> -->
                                <!-- CSS Icon for Risk Removed -->
                                <!-- <div class="css-icon risk">
                                    <div class="risk-shield">
                                        <div class="shield-base"></div>
                                        <div class="shield-cross"></div>
                                    </div>
                                    <div class="risk-barrier"></div>
                                </div> -->
                            <!-- </div> -->
                            <div class="services-content flex-grow-1">
                    ...
                    <div class="col-lg-3 col-md-6 mb-40 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="services-item hover-bg h-100 d-flex flex-column align-items-center text-center">
                            <!-- <div class="benefit-icon mb-4"> -->
                                <!-- CSS Icon for Expert Removed -->
                                <!-- <div class="css-icon expert">
        ...
        <div class="rs-contact-wrap bg5 pt-80 pb-80 md-pt-80 pb-80" style="background: linear-gradient(rgb(0 24 24 / 84%) 100%, rgb(0 44 2) 100%), url(https://www.pnas.org/content/118/32/e2112863118/F1.large.jpg) no-repeat; background-size: cover;">
            <div class="container">
                <div class="sec-title2 text-center mb-30">
                    <p class="title white-color" style="max-width:100%;">Would You Like to know more on how {{env('SITENAME')}} can help you obtain Environmental Clearance for your Mining Project?</p>
                    <button class="readon learn-more submit mb-30 mt-30">
                        <a href="{{route('contact-us')}}" class="text-white">Contact Us</a>
                    </button>
                    <div class="text-white">With extensive experience in mining sector environmental clearances, {{env('SITENAME')}} provides expert services to ensure your mining project meets all regulatory requirements. Our dedicated team manages the entire EC process from initial registration to final clearance, guaranteeing accuracy and timeliness.</div>
                </div>
            </div>
        </div>
        <hr>
